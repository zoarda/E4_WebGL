...
public class AudioManager : MonoBehaviour
{
    ...
    public IEnumerator SetvideoAudioAsync(string videoClipName)
    {
        ...
        Debug.Log($"shrimp:" + $"{videoClipName}");
        ...
        ResourceRequest videoRequest = Resources.LoadAsync<AudioClip>("Audio/" + $"{videoClipName}" + "_music");
        ...
        if (clip == null && sfxClip == null && videoClip == null)
        {
            Debug.LogWarning("Audio clips not found: " + VideoManager.Instance.GetVideoPlayer());
            BGMSource.clip = null;
    ...
    public void SyncAudioWithVideo()
    {
        try
        {
            ...
            float videoTime = WebGLStreamController.Instance.GetVideotime() / 1000f;
